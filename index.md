...
<div id='id-material'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                                    | **Actividades**
  ...
  03       | 20.01.2021   | Teoría local de curvas <br/> [Aula 03](aulas/aula03.pdf){:target="_blank"}     | Do Carmo, sección 1.5. <br/> Kühnel, secciones 2B y 2C, pp. 12--27. <br/> [Curva toroidal (Geogebra)](otros/toroidal_curve.ggb){:target="_blank"}
  04       | 22.01.2021   | Teorema fundamental de curvas [Aula 04](aulas/aula04.pdf){:target="_blank"}    | Do Carmo, sección 1.6. <br/> Kühnel, sección 2D, pp. 12--27. <br/> [Curva toroidal (Geogebra)](otros/toroidal_curve.ggb){:target="_blank"}
